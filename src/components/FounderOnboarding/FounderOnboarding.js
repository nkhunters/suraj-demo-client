       ...
       <div className="container-fluid">
           <div className="row">
               ...
               <div className="col-lg-8 col-md-6 col-sm-12 fo-rw1-col-2">
                <h2>Welcome to DueDash, Kevin!</h2>
                ...
                <div className="row fo-srw1">
                    <div className="col fo-srw1-col-1">
                        ...
                        <div className="fo-1st-disc">
                            ...
                            <p>Add your company details and get <br/> personalized feedback</p>
                        </div>
                    </div>
                </div>
                <div className="row fo-srw2">
                    <div className="col fo-srw1-col-1 srw2-col">
                        ...
                        <div className="fo-1st-disc">
                            ...
                            <p>Guidance and frameworks to<br/> make your company investable</p>
                        </div>
                    </div>
                </div>
                ...
                <button className="fo-btn-getstrtd">
                            Let's get started
                        </button>
               </div>
           </div>
